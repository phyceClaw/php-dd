...
static void emit_html_assets(void)
{
	static const char assets[] =
		...
		"pre.sf-dump samp{display:inline;}"
		"pre.sf-dump samp.sf-dump-collapsed{display:none;}"
		...
		"pre.sf-dump .sf-dump-ellip{display:none;color:#A0A0A0;}"
		"pre.sf-dump samp.sf-dump-collapsed + .sf-dump-ellip{display:inline;}"
